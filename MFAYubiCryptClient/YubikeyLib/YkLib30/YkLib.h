...
**		131107 / J E / 3.00 / Added NDEF helper functions               **
**                                                                      **
*************************************************************************/
...
#define YKLIB_MAX_CHAL_WAIT     1200
...
public:
    ...
    YKLIB_RC writeConfigBegin(unsigned char slot, CONFIG *cfg = 0, unsigned char *curAccCode = 0);
    ...
    YKLIB_RC writeNDEFBegin(unsigned char slot, YKLIB_NDEF_TYPE type, char *ndefStr, unsigned char *curAccCode = 0);
